export const connectionCopy = {
  tr: {
    eyebrow: "ANTICORE / AĞ OPERASYONLARI", title: "Kontrol konsolu", subtitle: "Motor, trafik ve erişim denetimi.", engineControl: "PAKET İŞLEME MOTORU",
    ready: "Motor beklemede.", active: "Motor devrede.", unknown: "Durum alınamıyor.",
    readyHint: "Profilini seç ve motoru başlat. Hedef erişimini bağlantı testleriyle doğrula.",
    ...
    profile: "Bağlantı profili", profileHint: "Ağında çalışan stratejiyi seç.", profileLocked: "Profil kilitli. Değiştirmek için motoru durdur.",
    configure: "Profilleri yönet", profileEmpty: "Profil yüklenemedi", retry: "Tekrar dene", targets: "Erişim denetimi", targetHint: "Listendeki ilk üç hedef · TLS bağlantı testi",
  ...
  en: {
    ...
    configure: "Manage profiles", profileEmpty: "Profiles unavailable", retry: "Try again", targets: "Access inspection", targetHint: "First three listed targets · TLS connection test",
