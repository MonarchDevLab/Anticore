...
## Anlık Durum
2026-09-09 00:32 — Güncel tasarım `e2bdef9`: kullanıcının seçtiği teknik/yoğun operasyon konsolu. 14 frontend testi, TypeScript/Vite, mevcut Edge kabulü ve 1080×720 ana kontrol görünürlüğü geçti. EXE, NSIS, MSI ve portable yenilendi; `Anticore_Baslat.cmd` artık bu sürümü açar. Başlatıcı/GUI/ZIP içerik SHA256 `7BA061F6D35F8DF1E126BDC6595FDEC72D2B2CF56EEF050138AAA2807F3C80D1`. Yedek `package-backups/20260909-003218`. Çalıştırılacak dosya `dist/Anticore.exe`. Görseller test verisi kullanır; native etkileşim/nihai kullanıcı kabulü ve yayın yapılmadı. Aşağıdaki kayıtlar tarihçedir.
